 ...
 */
final class Version20210609173541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apply (id INT AUTO_INCREMENT NOT NULL, annonce_id INT NOT NULL, email VARCHAR(90) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_BD2F8C1F8805AB2F (annonce_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
