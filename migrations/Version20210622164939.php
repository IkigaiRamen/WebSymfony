 ...
 */
final class Version20210622164939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD role VARCHAR(255) DEFAULT NULL, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE location location VARCHAR(255) NOT NULL, CHANGE expire expire DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP role, CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE location location VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE expire expire DATETIME DEFAULT \'NULL\'');
