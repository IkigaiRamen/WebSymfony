 ...
 */
final class Version20220428214753 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A1085646B3CA4B FOREIGN KEY (id_user) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote CHANGE id_post id_post INT NOT NULL, CHANGE id_user id_user INT NOT NULL');
    }
}
