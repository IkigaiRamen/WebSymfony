 ...
 */
final class Version20220428224511 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5A108564D1AA708F ON vote');
        $this->addSql('ALTER TABLE vote ADD id_commentaire INT DEFAULT NULL, DROP id_post, CHANGE id_user id_user INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A1085647FE2A54B FOREIGN KEY (id_commentaire) REFERENCES commentaire (id_commentaire)');
        $this->addSql('CREATE INDEX IDX_5A1085647FE2A54B ON vote (id_commentaire)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vote DROP FOREIGN KEY FK_5A1085647FE2A54B');
        $this->addSql('DROP INDEX IDX_5A1085647FE2A54B ON vote');
        $this->addSql('ALTER TABLE vote ADD id_post INT DEFAULT NULL, DROP id_commentaire, CHANGE id_user id_user INT DEFAULT NULL');
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A108564D1AA708F FOREIGN KEY (id_post) REFERENCES post (id_post)');
        $this->addSql('CREATE INDEX IDX_5A108564D1AA708F ON vote (id_post)');
    }
}
