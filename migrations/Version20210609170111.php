 ...
 */
final class Version20210609170111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apply (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, email VARCHAR(90) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
