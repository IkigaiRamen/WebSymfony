 ...
 */
final class Version20210609164748 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apply (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE apply_annonce (apply_id INT NOT NULL, annonce_id INT NOT NULL, INDEX IDX_769DAADF4DDCCBDE (apply_id), INDEX IDX_769DAADF8805AB2F (annonce_id), PRIMARY KEY(apply_id, annonce_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE apply_user (apply_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_F7F37EAA4DDCCBDE (apply_id), INDEX IDX_F7F37EAAA76ED395 (user_id), PRIMARY KEY(apply_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
