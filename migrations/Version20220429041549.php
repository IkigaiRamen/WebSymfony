 ...
 */
final class Version20220429041549 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE entretien (id INT AUTO_INCREMENT NOT NULL, apply_id INT NOT NULL, begin_at DATETIME NOT NULL, end_at DATETIME NOT NULL, titre VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2B58D6DA4DDCCBDE (apply_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE entretien ADD CONSTRAINT FK_2B58D6DA4DDCCBDE FOREIGN KEY (apply_id) REFERENCES apply (id)');
