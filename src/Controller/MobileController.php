...
class MobileController extends AbstractController
{
    ...
    public function newCertif(Request $request, NormalizerInterface $normalizable, EntityManagerInterface $entityManager): Response
    {
        ...
        //$form->handleRequest($request);
            ...
            $jsonContent=$normalizable->normalize($test,'json',['groups'=>['quizz']]);
     ...
     */
    public function edit(Request $request, NormalizerInterface $normalizable, Test $test, EntityManagerInterface $entityManager): Response
    {
